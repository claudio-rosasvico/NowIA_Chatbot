...
Route::middleware(['auth', 'super_admin'])->prefix('admin')->name('admin.')->group(function () {
    Route::get('/', [App\Http\Controllers\Panel\SuperAdminController::class, 'index'])->name('index');
    Route::patch('/users/{id}/toggle', [App\Http\Controllers\Panel\SuperAdminController::class, 'toggleUser'])->name('users.toggle');

    // Moved from public panel routes
